...
export default function ResumeBuilderScreen() {
  ...
  useEffect(() => {
    if (existingResume) {
      setCurrentResume(existingResume.data as any);
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.section}>
            ...
            <View style={styles.field}>
              <View style={styles.rowBetween}>
                ...
                <TouchableOpacity onPress={generateSummary} style={[styles.aiBtn, { backgroundColor: colors.secondary, borderRadius: 8 }]}>
        ...
        {step === 1 && (
          <View style={styles.section}>
            ...
            <StyledButton title="Add Experience" onPress={addExperience} variant="outline" icon={<Feather name="plus" size={16} color={colors.primary} />} />
          </View>
        )}
        ...
        {step === 2 && (
          <View style={styles.section}>
            ...
            <StyledButton title="Add Education" onPress={addEducation} variant="outline" icon={<Feather name="plus" size={16} color={colors.primary} />} />
          </View>
        )}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.field}>
              ...
              <TextInput
                ...
                onChangeText={(v) => setCurrentResume({ ...currentResume, skills: v.split(",").map((s) => s.trim()).filter(Boolean) })}
                multiline
                numberOfLines={3}
                textAlignVertical="top"
              />
            ...
            <View style={styles.field}>
              ...
              <View style={styles.templatesRow}>
                {TEMPLATES.map((t) => (
                  ...
                  >
                    <Text style={[styles.templateLabel, { color: currentResume.template === t.id ? "#fff" : colors.foreground }]}>
                      {t.label}
                    </Text>
                  </TouchableOpacity>
                ))}
            ...
            <Card elevated style={{ gap: 12 }}>
                ...
                <View>
                  ...
                  {currentResume.workExperience.map((e, i) => (
                    <View key={i} style={{ marginBottom: 8 }}>
                      <Text style={[styles.previewJob, { color: colors.foreground }]}>{e.jobTitle} at {e.company}</Text>
                      <Text style={[styles.previewDate, { color: colors.mutedForeground }]}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</Text>
              ...
              {currentResume.skills.length > 0 && (
                <View>
                  ...
                  <Text style={[styles.previewSkills, { color: colors.foreground }]}>{currentResume.skills.join(", ")}</Text>
                </View>
              )}
            </Card>
            <StyledButton
...
const styles = StyleSheet.create({
  ...
  stepBar: { flexDirection: "row", paddingHorizontal: 20, paddingVertical: 16, gap: 4, alignItems: "center", justifyContent: "space-between" },
